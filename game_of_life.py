...
class GameOfLife(metaclass=SingletonMeta):
    def __init__(self, width=20, height=20):
        ...
        self.dying_world = [[0 for _ in range(self.__width)] for _ in range(self.__height)]

    def form_new_generation(self):
        self.dying_world[random.randint(0, self.__width) - 1][random.randint(0, self.__height) - 1] = 1
        universe = self.world
